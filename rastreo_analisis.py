...
for domain, count in domain_to_id_counts1:
	...
	domain_origin1 = census_util.get_values_from_keys(neigh1, domain_to_fp_map1)
	...
	domain_origin2 = census_util.get_values_from_keys(neigh2,domain_to_fp_map1)
	...
	f.write("A un salto: ")
	for domain in domain_origin1:
		print domain+","
		f.write(domain+",")
	f.write("\n")
	
	f.write("A dos saltos: ")
	for domain in domain_origin2:
		print domain+","
		f.write(domain+",")
	f.write("\n\n")
